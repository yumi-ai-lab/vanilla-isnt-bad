...
export const copy = {
  en: {
    ...
    "kiosk.caption": "VANILLA ISN’T BAD. — a wide ice-cream counter, with a vanilla-striped awning and an app shelf below.",
  ...
  ja: {
    ...
    "hero.cta": "アプリを見る",
    "kiosk.caption": "VANILLA ISN’T BAD. の横に広がるアイス売り場。バニラ色の日よけから、カウンター下のアプリ棚へと続きます。",
    "kiosk.link": "アプリ一覧を見る",
    "gallery.title": "APPS",
