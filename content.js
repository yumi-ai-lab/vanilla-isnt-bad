...
export const previewApps = [
  { id:"focus", name:"Focus", flavor:0, featured:"new", sample:true, categories:["focus"],
  ...
  { id:"notes", name:"Notes", flavor:1, featured:"picked", sample:true, categories:["record"],
  ...
  { id:"trip", name:"Trip", flavor:2, featured:"seasonal", sample:true, categories:["organize"],
  ...
  { id:"tasks", name:"Tasks", flavor:3, sample:true, categories:["organize","focus"],
  ...
  { id:"budget", name:"Budget", flavor:4, sample:true, categories:["record","organize"],
  ...
  { id:"journal", name:"Journal", flavor:5, sample:true, categories:["record"],
...
export const copy = {
  en: {
    ...
    "menu.search": "Find an app by name or purpose",
    "menu.placeholder": "A note, a trip, a little focus…",
    "menu.clear": "Clear search",
    "menu.categories": "Choose a purpose",
    "menu.all": "All",
    "menu.empty": "No apps found. Try another word, or clear the filters.",
    "menu.reset": "Clear filters",
    "menu.more": "Show more",
    "menu.back": "Back to the menu",
    "terrace.details": "Explore this app",
  ...
  ja: {
    ...
    "menu.search": "アプリ名・できることで探す",
    "menu.placeholder": "メモ、旅、集中…",
    "menu.clear": "検索を消去",
    "menu.categories": "用途で絞り込む",
    "menu.all": "すべて",
    "menu.empty": "見つかりませんでした。別の言葉で探すか、絞り込みを解除してください。",
    "menu.reset": "絞り込みを解除",
    "menu.more": "もっと見る",
    "menu.back": "メニューへ戻る",
    "terrace.details": "アプリの案内を見る",
