...
export const copy = {
  en: {
    ...
    "kiosk.caption": "VANILLA ISN’T BAD. — our little storefront, with a vanilla-striped awning and an app shelf below the counter.",
  ...
  ja: {
    ...
    "hero.cta": "アプリを見る",
    "kiosk.caption": "VANILLA ISN’T BAD. の小さなお店。バニラ色の日よけから、カウンター下のアプリ棚へと続きます。",
    "kiosk.link": "アプリ一覧を見る",
    "gallery.title": "APPS",
