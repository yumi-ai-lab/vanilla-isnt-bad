...
- ほぼ白 #F8F8F4、チャコール #242426、淡いバニラ色 #E9DDA6。
...
- 冒頭はユーザー指定の「シンプルでいい。」。英語は「Simple is enough.」としています。補足説明・会社紹介は仮原稿で、content.js で変更できます。
...
assets/kiosk.png は、承認された屋台のデザインを内蔵 image_gen で部品化した画像です。実ファイルは不透明のマット背景です。HTML の SVG クリップで輪郭を切り抜いて表示しているため、空や看板は独立して扱えます。透過PNGであるとは扱っていません。
