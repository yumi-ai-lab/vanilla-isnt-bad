...
- 温かい白 #F7F3ED、ミルク色 #FCF9F4、チャコール #27231F、淡いバニラ色 #E9DDB8。
- 屋台はマットな白い塗装と布の質感、控えめな銀の金具、柔らかい自然光で仕上げています。空の棚には丸みと厚みのある白い縁、内壁と底面、淡い接地影があります。
- 英字は Inter、日本語は Noto Sans JP をサイト内から配信します。社名を最も強く、見出しを控えめに組んだサンセリフ主体の設計です。可変フォントの太さを用途別に調整し、英字は文字サイズに合わせた光学調整を使います。
- 屋台の社名はマットな黒の印刷をイメージし、屋根の明暗となじませています。APPS の文字には浅い刻印の縁を思わせる微細な明暗を付けています。空の見出しと本文は輪郭の明瞭な平面の文字です。
