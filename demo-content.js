...
export const demoNotes = {
  focus: {
    searchTerms: ["フォーカス", "ポモドーロ", "pomodoro"],
  ...
  trip: {
    searchTerms: ["旅行", "トリップ", "travel", "itinerary"],
  ...
  tasks: {
    searchTerms: ["やること", "タスク", "todo", "to-do"],
  ...
  budget: {
    searchTerms: ["家計簿", "バジェット", "予算", "expenses"],
